...
db2 = EliteD.create_database("user.db", "/home/pi/dc_bot") #Creates the database "user.db" at the given path
...
db2.insert_value("test", (1,)) #Inserts the value 1 into the test table
